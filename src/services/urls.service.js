...
const encodeUrl = async (body) => {
	...
	if (data) {
		return {status: httpStatus.CONFLICT, response: {error: 'Url already exists. You can search your URL in all the list by clicking view all the links or try new url'}};
	}
	const hash = uniqid();
